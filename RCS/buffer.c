...
1.2
date	2000.10.21.20.39.05;	author JeremyB;	state Exp;
branches;
next	1.1;
...
#ifdef EMX
  DEFVAR_PER_BUFFER ("emx-binary-mode", &current_buffer->emx_binary_mode, Qnil,
...
Automatically becomes buffer-local when set in any fashion.");
  ...
  DEFVAR_PER_BUFFER ("extended-attributes",
                     &current_buffer->extended_attributes, Qnil,
